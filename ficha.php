...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="style/ficha.css">
    </head>
    <body>
    <header>
        <nav>
            <img src="img/logo1.png">
            <a class="alink" href="home.php">Início</a>
            <div class="divnav">
    ...
    <section>
        ...
        <div>
            <br>
            <ul><a href="docs/amnese.pdf" download>Amnese (Adulto/Idoso)</a></ul>
            <ul><a href="docs/triagem.pdf" download>Ficha de Triagem</a></ul>
